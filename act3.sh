...
mv -v millenium_falcon/* death_star
...
mv -v chewbacca.txt han_solo.txt luke_skywalker.txt princess_leia.txt ..
mv -v chewbacca.txt han_solo.txt luke_skywalker.txt princess_leia.txt millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv -v millenium_falcon ..
mv -v millenium_falcon rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv -v darth_vader.txt ..
