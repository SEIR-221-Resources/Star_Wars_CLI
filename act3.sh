...
mv chewbacca.txt  han_solo.txt  luke_skywalker.txt  obi_wan.txt  princess_leia.txt /home/shilpa/GA/homework/Star_Wars_CLI/star_wars/empire/death_star
...
# Remember: darth_vader remains in the death_star and emperor_palpatine is still in the empire.
 mv chewbacca.txt  han_solo.txt  luke_skywalker.txt  princess_leia.txt /home/shilpa/GA/homework/Star_Wars_CLI/star_wars/empire/death_star/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon /home/shilpa/GA/homework/Star_Wars_CLI/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt /home/shilpa/GA/homework/Star_Wars_CLI/star_wars/empire
