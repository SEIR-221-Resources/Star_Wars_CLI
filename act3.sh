...
all txt files /Users/nicoleprati/sei/homework/Star_Wars_CLI/star_wars/empire/death_star
...
mv *.txt /Users/nicoleprati/sei/homework/Star_Wars_CLI/star_wars/empire/death_star/millenium_falcon
millenium_falcon git:(master) ✗ mv darth_vader.txt /Users/nicoleprati/sei/homework/Star_Wars_CLI/star_wars/empire/death_star
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon /Users/nicoleprati/sei/homework/Star_Wars_CLI/star_wars/rebellion

# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
 mv darth_vader.txt /Users/nicoleprati/sei/homework/Star_Wars_CLI/star_wars/rebellion
