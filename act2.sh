...
touch princess_leia.txt cat >> princess_leia.txt "Help me, Obi-Wan…You’re my only hope."
...
mv {"luke_skywalker.txt","obi_wan.txt","princess_leia.txt"} ~/GA/Star_Wars_CLI/star_wars/rebellion/millenium_falcon
# 7. Move the millenium_falcon into the death_star.
mv millenium_falcon ~/GA/Star_Wars_CLI/star_wars/death_star