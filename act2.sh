...
cd rebellion
printf "Help me, Obi-Wan…You’re my only hope." > princess_leia.txt
...
cd ..
mv luke_skywalker.txt  obi_wan.txt princess_leia.txt /home/shilpa/GA/homework/Star_Wars_CLI/star_wars/rebellion/millenium_falcon
# 7. Move the millenium_falcon into the death_star.
mv millenium_falcon /home/shilpa/GA/homework/Star_Wars_CLI/star_wars/empire/death_star
